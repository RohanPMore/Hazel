...
"WWWDDDDDDDWWWDDDDDDDWWWW"
"WWDDDDDDDDWWWDDDDDDDDWWW"
"WWDDDDDDDDWWWDDDDDDDDWWW"
"WWWDDDDDDDWWWDDDDDDDWWWW"
"WWWWDDDDDDDDDDDDDDDWWWWW"
"WWWWWDDDDDDDDDDDDDWWWWWW"
...
void Sandbox2D::OnUpdate(Hazel::Timestep ts)
{
...
#if 0
	{
		...
		rotation += ts * 50.0f; // Rotate at 50 degrees per second

		HZ_PROFILE_SCOPE("Renderer Draw");
		Hazel::Renderer2D::BeginScene(m_CameraController.GetCamera());
		Hazel::Renderer2D::DrawRotatedQuad({ 1.0f, 0.0f }, { 0.8f, 0.8f }, glm::radians(-45.0f) , {0.8f, 0.2f, 0.3f, 1.0f});
		Hazel::Renderer2D::DrawQuad({ -1.0f, 0.0f }, { 0.8f, 0.8f }, { 0.8f, 0.2f, 0.3f, 1.0f });
		Hazel::Renderer2D::DrawQuad({ 0.5f, -0.5f }, { 0.5f, 0.75f }, { 0.2f, 0.3f, 0.8f, 1.0f }); //{ 0.2f, 0.3f, 0.8f, 1.0f }
	...
	if (Hazel::Input::IsMouseButtonPressed(HZ_MOUSE_BUTTON_LEFT))
	{
		...
		for (int i = 0; i < 5; i++)
			m_ParticleSystem.EngineEmit(m_Particle);
	}

	m_ParticleSystem.OnEngineUpdate(ts);
	m_ParticleSystem.OnEngineRender(m_CameraController.GetCamera());
